...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_operator_exec_command#Coaster#Buffer#Object#import() abort
  ...
  execute join(['function! vital#_operator_exec_command#Coaster#Buffer#Object#import() abort', printf("return map({'make': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
