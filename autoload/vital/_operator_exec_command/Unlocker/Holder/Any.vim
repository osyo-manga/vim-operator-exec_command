...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_operator_exec_command#Unlocker#Holder#Any#import() abort
  ...
  execute join(['function! vital#_operator_exec_command#Unlocker#Holder#Any#import() abort', printf("return map({'is_option': '', '_vital_depends': '', 'throw': '', 'is_variable': '', 'is_value': '', 'is_holder': '', 'make': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
